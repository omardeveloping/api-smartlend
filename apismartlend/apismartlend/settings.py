...
SMARTLEND_SUPPORT_EMAIL = os.getenv('SMARTLEND_SUPPORT_EMAIL', 'smartlend.notificacion@gmail.com')
SMARTLEND_CODIGO_ACCESO_ESTUDIANTE = os.getenv('SMARTLEND_CODIGO_ACCESO_ESTUDIANTE', '027072003')
SMARTLEND_CODIGO_ACCESO_DOCENTE = os.getenv('SMARTLEND_CODIGO_ACCESO_DOCENTE', '015072003')
